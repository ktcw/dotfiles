...
plugins=(
  sudo git history zsh-autosuggestions tmux tmuxinator
)
...
POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX="%F{cyan}\u250C\u2500%F{default}"
POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{cyan}\u2514\u203A%F{default} "
# POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{cyan}\u2514\uF460%F{default} "
...
POWERLEVEL9K_USER_ROOT_BACKGROUND="magenta"
